Thicket Experiment Intro/Explanation
====================================

Single-page site explaining the motivations of the Thicket app.

Built using React for easy component sharing with main Thicket app.
